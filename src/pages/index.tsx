      ...
      {form.selected === "" ? (
        <div>
          <div className="d-flex row my-3 my-lg-5">
            ...
            <div className="col-12 col-lg-6 d-flex flex-grow-1 justify-content-start justify-content-lg-end mt-3 mt-lg-0 pe-0 pe-lg-2">
          ...
          <div className="row g-0 g-lg-5 w-100">
            {countries &&
              countries
                ...
                .map((country) => (
                  <div className="col-12 col-sm-6 col-lg-4 col-xl-3 d-flex flex-column mx-0 px-lg-4 mb-4 mb-lg-4">
                    <CountryCard
                      country={country}
